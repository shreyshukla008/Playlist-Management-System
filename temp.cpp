...
void delete_file(string a)
{
    ...
    {
        getline(f1,line);
        if(a.compare(line.c_str())!=0)
        f2<<line<<endl;
        else if (a.compare(line.c_str())==0)
        x=1;
    }
    f1.close();
    f2.close();
...
void push(string data)
{
    ...
    else if (top->song.compare(data)!=0)
    {
